package com.advocatediary.controller.datastructure;
...
public class CustomQueue {
    ...
    private LinkedList<AdvocateDiaryModel> vivaList; // Internal storage for the queue.
     ...
     *
     * @return the first AdvocateDiaryModel in the queue, or null if the queue is
 empty.
     * @throws IllegalStateException if the queue is empty.
     */
    public AdvocateDiaryModel deQueue() {
        try {
     ...
     *
     * @param studentModel the AdvocateDiaryModel to be added to the queue.
     * @return the current size of the queue after the operation , or -1 if the
     * queue is full.
     */
    public int enQueue(AdvocateDiaryModel studentModel) {
        if (isFull()) {
 ...
 empty.
     * @throws IllegalStateException if the queue is empty.
     */
    public AdvocateDiaryModel peek() {
        try{
